...
#toto=identify("https://www.youtube.com/watch?v=HHv_V2PkZGQ", "face_encodings.npy", "face_names.npy")
#toto=identify("csi", "face_encodings.npy", "face_names.npy")
toto=identify("file:img1.jpg", "face_encodings.npy", "face_names.npy")
